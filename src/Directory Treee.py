...
if __name__ == "__main__":
    ...
    start_directory = r'd:/Tera-joule/Terajoule - AI Architecture/AI Assistants/Nova - AI Coordinator v2/src'
    json_output_path = r'd:/Tera-joule/Terajoule - AI Architecture/AI Assistants/Nova - AI Coordinator v2/src/directory_tree.json'
    txt_output_path = r'd:/Tera-joule/Terajoule - AI Architecture/AI Assistants/Nova - AI Coordinator v2/src/directory_tree.txt'
